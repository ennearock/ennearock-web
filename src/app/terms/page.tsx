        ...
        <section className="overflow-hidden bg-[#131418] py-20 text-white sm:py-28">
          <Container>
            <div className="relative max-w-4xl">
              <div className="absolute -left-24 -top-24 h-64 w-64 rounded-full bg-[#596579]/15 blur-[90px]" />
          ...
          <Container>
            ...
            <div className="grid gap-12 lg:grid-cols-[240px_minmax(0,720px)] lg:gap-20">
              <aside className="h-fit lg:sticky lg:top-28">
                ...
                <nav className="mt-5 flex flex-col border-l border-[#d7dae0]" aria-label="Terms sections">
              ...
              <article className="space-y-12 text-[13px] leading-7 text-[#626670]">
                <section>
                  <h2 className="text-2xl font-semibold tracking-[-0.045em] text-[#131418]">Agreement</h2>
                ...
                <section id="services" className="scroll-mt-28">
                  <h2 className="text-2xl font-semibold tracking-[-0.045em] text-[#131418]">Services and accounts</h2>
                ...
                <section id="projects" className="scroll-mt-28">
                  <h2 className="text-2xl font-semibold tracking-[-0.045em] text-[#131418]">Client projects and ownership</h2>
                ...
                <section id="templates" className="scroll-mt-28">
                  <h2 className="text-2xl font-semibold tracking-[-0.045em] text-[#131418]">Template licenses</h2>
                ...
                <section id="fees" className="scroll-mt-28">
                  <h2 className="text-2xl font-semibold tracking-[-0.045em] text-[#131418]">Fees, taxes, and renewals</h2>
                ...
                <section id="use" className="scroll-mt-28">
                  <h2 className="text-2xl font-semibold tracking-[-0.045em] text-[#131418]">Acceptable use</h2>
                ...
                <section id="warranties" className="scroll-mt-28">
                  <h2 className="text-2xl font-semibold tracking-[-0.045em] text-[#131418]">Warranties and liability</h2>
                ...
                <section id="termination" className="scroll-mt-28">
                  <h2 className="text-2xl font-semibold tracking-[-0.045em] text-[#131418]">Suspension, termination, and changes</h2>
